...
export default function JobTools() {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        {/* Title */}
        <h2 className="text-[16px] font-semibold text-[#222] mb-4 text-left">
          My Job Tools
        </h2>

        {/* Tool List Section (171 x 124 Hug) */}
        <div className="w-[171px] h-[124px] flex flex-col gap-3 mb-4">
          {tools.map((tool, index) => (
            <div key={index} className="flex items-center justify-between">
              ...
              <button className="text-gray-300 hover:text-blue-500 p-1">
        ...
        <button
          className="h-[26px] self-center rounded-full px-3 py-1 text-[12px] whitespace-nowrap hover:bg-blue-50 transition-all"
          style={{
